...
(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, f, i, idt, lhs, lit, name, p, param, params, r, ref, rhs, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _m, _n, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat) {
      ...
      if (_ref3 = (name = (_ref4 = this.name) != null ? _ref4.unwrapAll().value : void 0), __indexOf.call(STRICT_PROSCRIBED, _ref3) >= 0) {
  ...
  IcedRuntime = (function(_super) {
    ...
    IcedRuntime.prototype.compileNode = function(o) {
      var access, assign, call, callv, file, inc, k, klass, lhs_vec, ns, req, rhs, v, val, window_mode, window_val, _i, _j, _len, _len2, _ref3;
      this.expressions = [];
      ...
      if (this.foundAwait) {
        ...
        lhs_vec = [];
        _ref3 = [iced["const"].k_noop, iced["const"].k];
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          k = _ref3[_i];
        ...
        assign = rhs;
        for (_j = 0, _len2 = lhs_vec.length; _j < _len2; _j++) {
          v = lhs_vec[_j];
